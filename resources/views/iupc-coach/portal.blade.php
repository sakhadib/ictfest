            ...
            <div class="grid gap-4">
                @forelse($registrations as $registration)
                    @php
                        ...
                        $selectedMethod = old('payment_method', $registration->payment?->method);
                    @endphp
                            ...
                            <div class="grid gap-6">
                                ...
                                <section class="rounded-lg border border-volt/20 bg-volt/10 p-5">
                                    ...
                                    <div class="mt-5 rounded-lg border border-white/10 bg-black/15 p-4">
                                        <p class="text-xs font-semibold uppercase tracking-[.18em] text-white/38">Send money number</p>
                                        <p class="mt-2 text-2xl font-semibold tracking-wide text-white">01XXXXXXXXX</p>
                                        <p class="mt-2 text-sm text-white/50">bKash and Nagad send money are both accepted.</p>
                                    </div>
