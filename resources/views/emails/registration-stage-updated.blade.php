                ...
                <table role="presentation" width="100%" cellspacing="0" cellpadding="0" style="max-width:640px;overflow:hidden;border-radius:18px;background:#ffffff;border:1px solid rgba(16,18,22,.08);">
                    <tr>
                        <td style="background:#101216;padding:26px 28px;">
                            ...
                            <p style="margin:18px 0 0;color:rgba(255,255,255,.56);font-size:12px;font-weight:700;letter-spacing:.18em;text-transform:uppercase;">Registration update</p>
                    ...
                    <tr>
                        <td style="padding:30px 28px;">
                            ...
                            <h2 style="margin:14px 0 0;font-size:24px;line-height:1.25;color:#101216;">{{ $content['heading'] }}</h2>
                            <p style="margin:12px 0 0;font-size:16px;line-height:1.7;color:#374151;">{{ $content['body'] }}</p>
                            ...
                            <div style="margin-top:28px;text-align:center;">
                                <a href="{{ $content['url'] }}" style="display:inline-block;border-radius:10px;background:#101216;color:#ffffff;font-size:14px;font-weight:700;text-decoration:none;padding:13px 18px;">
                                    {{ $content['button'] }}
                                </a>
                            </div>
                            ...
                            <p style="margin:28px 0 0;font-size:13px;line-height:1.7;color:#6b7280;">
                                ...
                                <br>
                                <a href="{{ $content['url'] }}" style="color:#d4574e;">{{ $content['url'] }}</a>
                            </p>
                        </td>
                    </tr>
