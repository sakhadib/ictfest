...
@section('title', 'Gamejam Registration Submitted | 12th IUT ICT FEST 2026')
...
<section class="px-4 pb-32 pt-36 sm:px-6 lg:px-8">
    <div class="mx-auto max-w-4xl">
        <div class="rounded-lg border border-white/10 bg-white/[.035] p-6 text-center sm:p-10">
            <div class="mx-auto grid h-14 w-14 place-items-center rounded-full bg-volt/10 text-volt">
            ...
            <p class="mx-auto mt-5 max-w-xl text-sm leading-7 text-white/56">
                Your Gamejam registration has been submitted for review.
            </p>
            ...
            <div class="mt-10 flex justify-center">
                <a href="{{ url('/') }}" class="inline-flex items-center justify-center rounded-md bg-white px-5 py-3 text-sm font-semibold text-ink transition hover:bg-volt">
                    Back Home
                </a>
            </div>
        </div>
