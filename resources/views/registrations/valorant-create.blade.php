...
@section('title', 'Valorant Registration | 12th IUT ICT FEST 2026')
...
@php
    ...
    $oldParticipants = old('participants', array_fill(0, 5, []));
    $memberCount = max(5, min(7, count($oldParticipants)));
@endphp
            ...
            <div class="mt-8 grid gap-5">
                <div class="flex items-center gap-4">
                    ...
                    <div>
                        ...
                        <p class="mt-1 text-sm font-medium text-white">5-7 members</p>
                    </div>
                </div>
                <div class="flex items-center gap-4">
                ...
                <div class="flex items-center gap-4">
                    ...
                    <div>
                        ...
                        <p class="mt-1 text-sm font-medium text-white">06-48372</p>
                    </div>
                </div>
            </div>
        </aside>

        <form method="POST" action="{{ route('valorant.register.store') }}" class="border-y border-white/10 py-8">
            @csrf
            ...
            <div class="mt-12">
                <p class="text-xs font-medium uppercase tracking-[.22em] text-white/38">Roster</p>
                    ...
                    @for($index = 0; $index < 7; $index++)
                        ...
                        <div data-member-section="{{ $index }}" class="border-t border-white/10 py-8 first:border-t-0 first:pt-0 last:pb-0 {{ ! $visible ? 'hidden' : '' }}">
                            <div class="flex items-center justify-between gap-4">
                                <h3 class="text-lg font-semibold text-white">Player {{ $index + 1 }}</h3>
                                @if($index === 0)
                    ...
                    <div>
                        ...
                        <div class="mt-2 grid grid-cols-2 gap-3">
                            <label class="cursor-pointer">
                                ...
                                <span class="flex items-center justify-center rounded-md border border-white/10 bg-white/[.035] px-4 py-3 text-sm font-semibold text-white/58 transition peer-checked:border-iris/60 peer-checked:bg-iris/10 peer-checked:text-white hover:border-white/24">
                                    bKash
                                </span>
                            </label>
                            <label class="cursor-pointer">
...
<script>
    (() => {
        ...
        const updateAddButton = () => {
            addButton.disabled = visibleSections().length >= 7;
