...
@section('title', 'Hackathon Registration | '.config('app.name'))
    ...
    <div class="mx-auto max-w-6xl">
        <div class="max-w-4xl">
            ...
            <h1 class="mt-8 text-4xl font-semibold leading-[1.06] text-white sm:text-5xl lg:text-6xl">
                Register your Agentic Builder team.
            </h1>
    ...
    <div class="mx-auto grid max-w-6xl gap-14 lg:grid-cols-[.68fr_1.32fr]">
            ...
            <div class="mt-8 grid gap-5">
                ...
                <div class="flex items-center gap-4">
                    ...
                    <div>
                        ...
                        <p class="mt-1 text-sm font-medium text-white">2000 BDT per selected team</p>
                    </div>
                </div>
            </div>
        </aside>
        ...
        <form method="POST" action="{{ route('hackathon.register.store') }}" class="border-y border-white/10 py-8">
            ...
            <div class="mt-12">
                ...
                <div class="mt-6">
                    <button id="addMember" type="button" class="inline-flex w-full items-center justify-center rounded-md border border-white/12 bg-white/[.04] px-4 py-2.5 text-sm font-medium text-white/72 transition hover:border-ember/60 hover:text-white sm:w-auto">
                        Add Member
                    </button>
                </div>
            </div>
