...
@php
    ...
    $memberCount = max(1, min(3, count($oldParticipants)));
@endphp
...
<section class="px-4 pb-20 pt-36 sm:px-6 lg:px-8">
    <div class="mx-auto max-w-6xl">
        <div class="max-w-4xl">
            ...
            <div class="mt-8 rounded-lg border border-volt/30 bg-volt/10 p-5">
...
<section class="px-4 pb-32 sm:px-6 lg:px-8">
    <div class="mx-auto grid max-w-6xl gap-14 lg:grid-cols-[.68fr_1.32fr]">
            ...
            <div class="mt-8 grid gap-5">
                <div class="flex items-center gap-4">
                    ...
                    <div>
                        ...
                        <p class="mt-1 text-sm font-medium text-white">1-3 members</p>
                    </div>
                </div>
                <div class="flex items-center gap-4">
        ...
        <form method="POST" action="{{ route('gamejam.register.store') }}" class="border-y border-white/10 py-8">
            @csrf
            ...
            <div class="mt-12">
                ...
                <div class="mt-6">
                    <button id="addMember" type="button" class="inline-flex w-full items-center justify-center rounded-md border border-white/12 bg-white/[.04] px-4 py-2.5 text-sm font-medium text-white/72 transition hover:border-volt/60 hover:text-white sm:w-auto">
                        Add Member
                    </button>
                </div>
            </div>
...
<script>
    (() => {
        ...
        const updateAddButton = () => {
            addButton.disabled = visibleSections().length >= 3;
